...
const SIZE_CHECK = Dict(
    "ACM.jl" => 31189,
    "ACMPCA.jl" => 41932,
    "APIGateway.jl" => 211519,
    "AWSSDK.jl" => 4136,
    "AlexaForBusiness.jl" => 68227,
    "AppStream.jl" => 58098,
    "AppSync.jl" => 39592,
    "ApplicationAutoScaling.jl" => 70702,
    "Athena.jl" => 16631,
    "AutoScaling.jl" => 136756,
    "AutoScalingPlans.jl" => 13237,
    "Batch.jl" => 49477,
    "Budgets.jl" => 26417,
    "CUR.jl" => 4300,
    "Cloud9.jl" => 23082,
    "CloudDirectory.jl" => 153037,
    "CloudFormation.jl" => 125205,
    "CloudFront.jl" => 106858,
    "CloudHSM.jl" => 39251,
    "CloudHSMV2.jl" => 19432,
    "CloudSearch.jl" => 42029,
    "CloudSearchDomain.jl" => 25552,
    "CloudTrail.jl" => 34050,
    "CloudWatch.jl" => 46208,
    "CloudWatchEvents.jl" => 26589,
    "CloudWatchLogs.jl" => 56491,
    "CodeBuild.jl" => 42634,
    "CodeCommit.jl" => 72089,
    "CodeDeploy.jl" => 79742,
    "CodePipeline.jl" => 57288,
    "CodeStar.jl" => 25589,
    "CognitoIdentity.jl" => 36065,
    "CognitoIdentityServiceProvider.jl" => 187107,
    "CognitoSync.jl" => 34490,
    "Comprehend.jl" => 51362,
    "ConfigService.jl" => 92288,
    "Connect.jl" => 36487,
    "CostExplorer.jl" => 24620,
    "DAX.jl" => 36487,
    "DLM.jl" => 9077,
    "DMS.jl" => 116846,
    "DataPipeline.jl" => 37155,
    "DeviceFarm.jl" => 118509,
    "DirectConnect.jl" => 78465,
    "DirectoryService.jl" => 68922,
    "Discovery.jl" => 33479,
    "DynamoDB.jl" => 148626,
    "DynamoDBStreams.jl" => 15154,
    "EC2.jl" => 803971,
    "ECR.jl" => 46489,
    "ECS.jl" => 127330,
    "EFS.jl" => 38428,
    ...
    "EMR.jl" => 65463,
    "ES.jl" => 36593,
    "ElastiCache.jl" => 132065,
    "ElasticBeanstalk.jl" => 117825,
    "ElasticTranscoder.jl" => 59926,
    "FMS.jl" => 16901,
    "Firehose.jl" => 50805,
    "GameLift.jl" => 206334,
    "Glacier.jl" => 120850,
    "Glue.jl" => 124543,
    "Greengrass.jl" => 108741,
    "GuardDuty.jl" => 61699,
    "Health.jl" => 13858,
    "IAM.jl" => 334087,
    "ImportExport.jl" => 10123,
    "Inspector.jl" => 90570,
    "IoT1ClickDevicesService.jl" => 14021,
    "IoT1ClickProjects.jl" => 20701,
    "IoTAnalytics.jl" => 52302,
    "IoTJobsDataPlane.jl" => 8028,
    "Iot.jl" => 238688,
    "IotData.jl" => 6062,
    "KMS.jl" => 117352,
    "Kinesis.jl" => 66262,
    "KinesisAnalytics.jl" => 52020,
    "KinesisVideo.jl" => 21774,
    "KinesisVideoArchivedMedia.jl" => 17986,
    "KinesisVideoMedia.jl" => 3327,
    "Lambda.jl" => 97590,
    "LexModelBuildingService.jl" => 105713,
    "LexRuntime.jl" => 14258,
    "Lightsail.jl" => 110447,
    "MQ.jl" => 27065,
    "MTurk.jl" => 86561,
    "MachineLearning.jl" => 67297,
    "Macie.jl" => 11544,
    "MarketplaceCommerceAnalytics.jl" => 13371,
    "MarketplaceEntitlementService.jl" => 2623,
    "MarketplaceMetering.jl" => 6508,
    "MediaConvert.jl" => 208791,
    "MediaLive.jl" => 101346,
    "MediaPackage.jl" => 23555,
    "MediaStore.jl" => 15349,
    "MediaStoreData.jl" => 9477,
    "MediaTailor.jl" => 6871,
    "MigrationHub.jl" => 34585,
    "Mobile.jl" => 12041,
    "MobileAnalytics.jl" => 2462,
    "Neptune.jl" => 173801,
    "OpsWorks.jl" => 179668,
    "OpsWorksCM.jl" => 36241,
    "Organizations.jl" => 153350,
    "PI.jl" => 9007,
    "Pinpoint.jl" => 135942,
    "Polly.jl" => 22120,
    "Pricing.jl" => 9393,
    "RDS.jl" => 329165,
    "Redshift.jl" => 192706,
    "Rekognition.jl" => 111811,
    "ResourceGroups.jl" => 18026,
    "ResourceGroupsTaggingAPI.jl" => 12842,
    "Route53.jl" => 170983,
    "Route53Domains.jl" => 70326,
    "S3.jl" => 172580,
    "SES.jl" => 169336,
    "SMS.jl" => 14871,
    "SNS.jl" => 60321,
    ...
    "SWF.jl" => 116858,
    "SageMaker.jl" => 96626,
    "SageMakerRuntime.jl" => 2777,
    "SecretsManager.jl" => 87313,
    "ServerlessApplicationRepository.jl" => 19241,
    "ServiceCatalog.jl" => 99618,
    "ServiceDiscovery.jl" => 37098,
    "Shield.jl" => 27957,
    "SimpleDB.jl" => 22620,
    "Snowball.jl" => 50633,
    "StepFunctions.jl" => 31189,
    "StorageGateway.jl" => 168076,
    "Support.jl" => 29610,
    "TranscribeService.jl" => 13539,
    "Translate.jl" => 2859,
    "WAF.jl" => 176498,
    "WAFRegional.jl" => 185121,
    "WorkDocs.jl" => 71617,
    "WorkMail.jl" => 46483,
    "WorkSpaces.jl" => 32975,
    "XRay.jl" => 14127,
...
function syntax_check(dir::AbstractString)
